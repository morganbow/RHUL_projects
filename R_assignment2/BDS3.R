...
while (B<5001) {
  ...
  Test.MSE[B] <- sum((Boston.Testy-test.pred)^2)/length(Boston.Testy)
  B = B + 1
  
}
par(mfrow=c(1,2))
plot(1:5000,Test.MSE,type="l",main="Test MSE against B", xlab="B", ylab="Test MSE")
plot(20:5000,Test.MSE[20:5000],type="l",main="Test MSE against B[20:5000]", xlab="TestMSE", ylab="B")
